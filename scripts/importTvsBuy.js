...
// New trade from 2015-06-02 contract note: BUY 21 x TVS MOTOR COMPANY LTD @ 230
const trade = {
  date: '2015-06-02',
  type: 'BUY',
...
`).get(inv.id);
console.log(`\nTVS Motor: Bought ${pos.bought}, Sold ${pos.sold}, Net ${pos.bought - pos.sold}`);
